...
# **<FONT SIZE=4>[7]</font>**
# Sea $f(x) = \displaystyle \arctan \left( \frac{\sin (x)}{1 + \cos (x)} \right )$. Calcula la recta tangente a la gráfica de $f$ en $x = 0$. 
# 
# 

# **<FONT SIZE=4>[8]</font>**
# Sea la función $f$ dada por $f(x) = (4x+1)^{(2+ \sin (x^2))}$.  Calcula su derivada en cualquier punto.  
# 
# 
...
# **<FONT SIZE=4>[11]</font>**
# Sea la función $f$ dada por $\displaystyle f(x) = \frac{1}{2} x |x|$. ¿Cuál es la clase de $f$?  
# 
# 

# **<FONT SIZE=4>[12]</font>** Consideramos la función $f$ dada por
# 
# $$
# f(x) =
# \begin{cases}
...
# **<FONT SIZE=4>[14]</font>**
# Calcula los extremos relativos, y absolutos si existen, de la función definida en el 
# intervalo $\left [ -\frac{1}{2} , \frac{3}{2} \right ]$ por $f(x) = x^2 - 2|x| + 2$.
#       
# 

# **<FONT SIZE=4>[15]</font>**
# Considera la función $f:\mathbb{R} \rightarrow \mathbb{R}$ dada por $\displaystyle{f(x)=\frac{|x|}{e^{x-1}}}$.
# 
...
# **<FONT SIZE=4>[17]</font>**
# ¿En qué intervalo es creciente la función $f$ dada por $f(x)=x^3e^x$? ¿Es cóncava o convexa en ese intervalo? Esboza su gráfica.  
# 
...
# **<FONT SIZE=4>[20]</font>**
# Esboza la gráfica de una función cuya pendiente sea siempre positiva y creciente. ¿Conoces alguna función elemental que sea ejemplo de esta situación? <br>  Esboza la gráfica de una función cuya pendiente sea siempre positiva y decreciente. ¿Conoces alguna función elemental que sea ejemplo de esta situación?  
#      

# **<FONT SIZE=4>[21]</font>**
# Un rectángulo cuya base está en el eje de abscisas tiene sus dos vértices superiores en la parábola $y = 12 - x^2$. ¿ Cuál es la mayor área que puede tener ese rectángulo? Indica sus dimensiones.  
# 
# 
...
# **<FONT SIZE=4>[24]</font>**
# Construye el polinomio de Taylor, $p$, de primer orden para la función $g(x) = \sin (x)$, centrado en el punto $x_0 = \pi/2$.
# 
...
# **<FONT SIZE=4>[25]</font>**
# Determina el polinomio de Taylor de orden dos de la función $f(x)= \arcsin(x)$ relativo al punto $x_{0}=0$. <br> Utiliza el polinomio anterior para obtener, de forma aproximada, el ángulo cuyo seno es $\frac{1}{10}$.  
#     
...
# Si la recta tangente a la gráfica de la función $y = f(x)$ en el punto $(4,3)$
...
# Se considera la función $f: \mathbb{R} \longrightarrow \mathbb{R}$ dada por:  
# 
# $$
# f(x)=
# \begin{cases}
...
# Consideramos la ecuación \, $x e^{-x} = e^{-3}$.
# 
...
# Halla el radio y la altura de una lata cilíndrica de refresco de
