...
# <!-- \begin{figure}[h!]
# \begin{center}
# \centerline{\input{apuntes_calculo/sqrt2.pstex_t}} 
# \caption{El número $\sqrt{2}\mathbb{N}ot\in\Q$. \label{fig:sqrt2}}
# \end{center}
# \end{figure} -->
# 
...
# <!-- \begin{figure}[h!]
# \begin{center}
# \centerline{\input{apuntes_calculo/rectareal.pstex_t}} 
# \caption{Recta real. \label{fig:rectareal}}
# \end{center}
# \end{figure} -->
# 
