...
# **<FONT SIZE=4>[1]</font>** 
# Demuestra que $\displaystyle{\,\,8-\frac14\sqrt{1-4x^2}}$ es una primitiva de  $\displaystyle{\,\,\frac{x}{\sqrt{1-4x^2}}}.$ ¿Es su única primitiva? En caso afirmativo justifica el porqué, en caso negativo encuentra otra.
...
# **<FONT SIZE=4>[3]</font>**
# Sea la función $f : \mathbb{R} \longrightarrow \mathbb{R}$ dada por $f(x) = x^3 -2$. Consideramos la partición $P=\{-2,-1,1,4\}$. Elige la opción correcta.
#     
# $$
#     \begin{array}{lll}
#     \\
...
# **<FONT SIZE=4>[4]</font>**
# Sea $f$ una función continua en $x \in [2,4]$, de la que sabemos que $\underset{x \in [2,4]}{\min} f(x) = 3$ y $\underset{x \in [2,4]}{\max} f(x) = 6$.
# 
...
# **<FONT SIZE=4>[5]</font>**
# Si $f$ y $g$ son funciones continuas, halla:
#   
...
# **<FONT SIZE=4>[6]</font>**
# Halla los extremos relativos de la función $F(x) = \displaystyle{\int_1^x \frac{sen( t)}{t} \, }$, con $x > 1$.
# 
# 

# **<FONT SIZE=4>[7]</font>**
# Halla una función $f$ y un número real $a$ tales que:
# 
# $$
...
# **<FONT SIZE=4>[8]</font>**
# Halla el área de la figura limitada por las rectas $y = x$, $y = 2x$ e $y = 4$.
# 
# 
...
# **<FONT SIZE=4>[10]</font>**
# Maruja conduce a una velocidad 
# 
# $$
# v_M(t)= \displaystyle{90+15\cos\left(\frac{\pi}{2}t\right)\,\mathrm{km/h}}
# $$ 
# y Pepe lo hace a una velocidad 
# 
# $$
...
# **<FONT SIZE=4>[11]</font>**
# En un circuito eléctrico se ha medido la corriente en distintos instantes de tiempo, obteniendo el cuadro siguiente:
# 
# | $t_k$      |    2   |    4   |    6   |
# |------------|:------:|:------:|:------:|
# | $i(t_k)$   |    3   |    5   |    9   |
...
# **<FONT SIZE=4>[12]</font>**
# Halla el área limitada por la gráfica de $f(x) = xe^{-2x}$ y el eje $OX$ en el intervalo $[0 , \infty)$.
# 
# 

# **<FONT SIZE=4>[13]</font>**
# Halla el valor de la integral $\displaystyle{\int_0^1 x^2 \ln (x) \, dx}.$
# 
# 

# **<FONT SIZE=4>[14]</font>**
# Calcula $\displaystyle{\int_0^{\infty} \frac{1}{\sqrt{x} (x+1)} \, dx}$
# 
# 

# **<FONT SIZE=4>[15]</font>**
# Una esfera de madera de radio $R = 10\,$cm se recubre de una capa de acero de $1\,$cm de espesor. Calcula, mediante integración, el volumen de acero necesario.
# 
# 

# **<FONT SIZE=4>[16]</font>**
# En procedimientos de diagnosis médica por imagen (como, por ejemplo, la resonancia magnética), se toman numerosos datos para obtener mediante cálculos computacionales una imagen tridimensional que permita visualizar la parte del cuerpo que se estudia. El proceso es similar al empleado para calcular el volumen de un sólido usando áreas de secciones perpendiculares a un eje. Supongamos que el siguiente cuadro indica el valor del área de unas cuantas secciones de un tumor, tomadas a una distancia de un milímetro entre cada dos imágenes:
#      
...
# **<FONT SIZE=4>[17]</font>**
# Calcula el valor del área comprendida entre la gráfica de la función $f(x)=sen(x)$ y el eje $OX$ limitada
...
# **<FONT SIZE=4>[18]</font>**
# Sea la función $f(x) = \sqrt{-x \ln (x)}$ definida en los puntos $x$ para
# los cuales $-x \ln(x) \geq 0$.  Calcula el volumen del sólido generado al rotar todo su dominio alrededor del eje $OX$.
# 
# 

# **<FONT SIZE=4>[19]</font>**
# Comprueba que $f(x)=\frac23 e^x+e^{-2x}$ es una solución de la ecuación diferencial $y'+2y = 2 e^x.$
# 
# 

# **<FONT SIZE=4>[20]</font>**
# Halla la solución general de la ecuación diferencial:  $y^{\prime} x = y \ln (y)$.
# 
# 
...
# **<FONT SIZE=4>[22]</font>**
# Resuelve la ecuación diferencial:  $\displaystyle{y^{\prime} - \frac{y}{x-2} = 2 (x-2)^2}$.
# 
# 

# **<FONT SIZE=4>[23]</font>**
# Resuelve la ecuación diferencial: $y^{\prime} + y = sen(x) $ con la condición inicial $y(\pi)=1$.
# 
# 
...
# **<FONT SIZE=4>[25]</font>**
# La cantidad de medicamento en un órgano dentro del cuerpo humano sigue la ecuación
# 
# $$
#       \frac{dx}{dt}=\text{velocidad de entrada} - \text{velocidad de salida,}
# $$
# donde $x(t)$ es la cantidad de medicamento en el instante $t.$ Recordemos que la velocidad de entrada o salida es igual al producto de la concentración del medicamento (a la entrada o a la salida, respectivamente) multiplicada por la velocidad del flujo sanguíneo.
# 
...
# **<FONT SIZE=4>[27]</font>**
# Razona la veracidad o falsedad de:
# 
# $$
...
# ¿En qué se transforma la siguiente integral al realizar el cambio de variable $\sin(3x)=t$?  
# 
# $$
...
# Resuelve la integral $\displaystyle \int{\frac{dx}{\sqrt{5x+8}}}$ mediante un cambio de variable.
...
# Sea $f$ una función continua en $[0,\,\infty),$ tal que $f(0)\neq 0$. Elige la opción correcta:
# 
...
# Consideramos la función $f$ dada por $f(x) = 3 + 6\cos (2x)$.
# 
...
# El valor de $\displaystyle\int_{-\frac{\pi}{4}}^0{\sin^3(x)\cos(x)\, dx}\,\,$ es:
#       
...
# El valor de $\displaystyle\int_{\frac{\pi}{2}}^{\pi}{\frac{\cos(3x)}{\sqrt{5+\sin(3x)}}\,dx}\,\,$ es:
#     
...
# Sea $f(x) = x (x-a)$, $a > 0$, y $V_f$ el volumen engendrado al girar en torno al eje $OX$ la región
...
# Calcula el volumen del cuerpo de revolución que se obtiene al girar, en torno al eje $OX$, la intersección de los círculos \, $x^2 + y^2 \leq 16$ \, y \, $(x-3)^2 + y^2 \leq 25$.

# **<FONT SIZE=4>[12 C]</font>**
# Halla el volumen del sólido generado al girar alrededor del eje $OX$ el recinto limitado por los semiejes positivos, la parábola $y = -x^2+2x+3$ y la recta $y = 2-2x/3$.

# **<FONT SIZE=4>[13 C]</font>**
# Sea $Q(t) = \cos (\pi t)$ la carga eléctrica de un circuito en un instante de tiempo $t$.
# 
...
# El valor aproximado de la integral $\displaystyle{\int_{\pi/4}^{3\pi/4}{\mbox{cotan}(x)\,}dx\,\,}$  usando el método de Simpson (simple) es:
#       
# * $\displaystyle 0$      
...
# Calcula la recta, $r$, tangente a la función $f(x)={x}^{2}-2x+1$ por el punto $(3,f(3))$. A continuación, dibuja la región del plano $R$ limitada por la gráfica de $f$, la recta $r$ y el semieje positivo $OX$ y calcula la superficie de dicha región.   

# **<FONT SIZE=4>[16 C]</font>**
# Halla el área de la figura limitada por la curva $y=\tan(x)$, el eje $OY$y la recta $y=1$. Calcula también el volumen generado al hacer girar la figura anterior alrededor del eje $OX$. 

# **<FONT SIZE=4>[17 C]</font>**
# Calcula la superficie del plano limitada por la gráfica de $y=\ln(\frac{1}{x})$, la recta $x=\frac{1}{2}$ y la recta $x=2$.

# **<FONT SIZE=4>[18 C]</font>**
# Sea $\displaystyle f(x)=ax+b+\frac{8}{x}$, donde $a$ y $b$ son dos números reales.
# 
...
# **<FONT SIZE=4>[19 C]</font>**
# El área del recinto limitado por $y=ln(x)$ y el eje  de abscisas entre $x=\displaystyle{\frac12}$ y $x=2$ está dada por:
# 
...
# **<FONT SIZE=4>[20 C]</font>**
# El volumen de revolución generado al girar, alrededor del eje OX, la superficie comprendida entre las curvas  $y=x^2$ e $y = \sqrt{x}$ se calcula así:
# 
...
# **<FONT SIZE=4>[21 C]</font>**
# Calcula el volumen que genera la curva $g(x) = \dfrac{1}{x-1}$ al girar alrededor del eje $OX,$ para $0 \leq x \leq 2$.

# **<FONT SIZE=4>[22 C]</font>**
# La integral $\displaystyle\int_0^5{\frac{1}{\sqrt{25-5x}}}\, dx$:
# 
...
# **<FONT SIZE=4>[23 C]</font>**
# ¿Cuál es la solución del siguiente problema de valor inicial?
# 
# $$
#       \left\{
#       \begin{array}{c}
...
# **<FONT SIZE=4>[25 C]</font>**
# Calcula la solución general de la siguiente ecuación diferencial ordinaria: 
# 
# $$
# v^\prime = v + t\,e^t.
# $$ 

# **<FONT SIZE=4>[26 C]</font>**
...
# **<FONT SIZE=4>[27 C]</font>**
# Sea la ecuación diferencial ordinaria $\displaystyle y^\prime = x^2y$, donde $y$ es una función de $x.$ Entonces:
# 
# * la solución general es $\displaystyle y=k\,e^{-x^3/3}$, donde $k$ es constante de integración  
# * la solución general es $\displaystyle y= k\,e^{x^3/3}$, donde $k$ es constante de integración        * no puedo hallar la solución porque no es una ecuación diferencial ordinaria separable ni tampoco lineal 
