...
# * ...
# 
# Gráficamente ([puedes jugar con el gráfico, moviendo $x_{0}$, en esta gráfica de Desmos](https://www.desmos.com/calculator/ekj7kblys7?lang=es) ):
# 
...
# 
# * [Entrada en la Wikipedia (inglés).](https://en.wikipedia.org/wiki/Newton%27s_method)
# * [Página sobre Newton-Raphson en *Python Numerical Methods*, Berkeley (inglés).](https://pythonnumericalmethods.berkeley.edu/notebooks/chapter19.04-Newton-Raphson-Method.html)
# * [Página del Departamento de Estadística de la Universidad de Las Palmas de Gran Canaria.](https://estadistica-dma.ulpgc.es/FCC/05-3-Raices-de-Ecuaciones-2.html)
# * [Applet de Geogebra escrito por Ignacio Larrosa.](https://www.geogebra.org/m/XCrwWHzy)
