...
# Por claridad en la implementación y en los cálculos, será habitual que el nombre de la variable simbólica y el nombre del objeto **Sympy** en el que se alamacena coincidan, pero esto no tiene porque ser así:
