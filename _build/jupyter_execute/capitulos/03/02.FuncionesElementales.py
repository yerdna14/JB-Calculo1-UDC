...
# $[-\frac{\pi}{2},\frac{\pi}{2}]$. 
# 
# Definimos entonces la función arco-seno, $\text{asin}(x)$, como la función que, dado un
...
# 
# Por tanto la función $\text{asin}(x)$ tiene como dominio el intervalo $[-1,1]$ y como imagen
...
# 
# Definimos entonces la función arco-coseno, $\text{acos}(x)$, como la función que, dado un
...
# 
# Definimos entonces la función arco-tangente, $\text{atan}(x)$, como la función 
...
# 
# Por tanto la función $\text{atan}(x)$ tiene como dominio todo $\mathbb{R}$ y como imagen el
